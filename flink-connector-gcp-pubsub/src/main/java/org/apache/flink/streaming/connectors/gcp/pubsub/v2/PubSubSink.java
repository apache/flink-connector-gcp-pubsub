...
public abstract class PubSubSink<T> implements Sink<T> {
    ...
    public abstract static class Builder<T> {
        ...
        /**
         * Sets the serialization schema used to serialize incoming data into a {@link
         * PubsubMessage}.
         *
         * <p>Setting this option is required to build {@link PubSubSink}.
         */
         ...
         *
         * <p>The default value is {@code false}. This must be set to {@code true} when publishing
         * an {@link PubsubMessage} with an ordering key set.
         */
